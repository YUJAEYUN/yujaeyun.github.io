# 유재윤 | Product Engineer

문제를 정의하고 해결하는 개발자의 포트폴리오입니다.

🔗 **Live Site:** [https://yujaeyun.github.io](https://yujaeyun.github.io)
...
저는 단순히 도구를 '사용하는' 개발자가 아닌, **OS, 네트워크, DB와 같은 '기본 원리'를 깊이 있게 '이해하는' 개발자**를 목표로 합니다.
...
### 1. 썸타임 (Sometime) - 지역 대학생 소개팅 앱

- React Native, Nest.js 기반 실제 서비스 운영 중
- 초기창업패키지 딥테크 선정

### 2. 신사타 (Shinsata) - 레거시 코드 개선
...
더 많은 프로젝트는 [포트폴리오 사이트](https://yujaeyun.github.io)에서 확인하실 수 있습니다.
