...
스타트업에서 주 7일 숙식하며 서비스를 개발했던 경험을 통해 **비즈니스 가치와 기술적 완성도의 균형**이라는 개발 철학을 세웠습니다.
...
- **서비스 개발** - 썸타임 (초기창업패키지 딥테크 선정, 매출 1억, 사용자 7,000명)
- **외주 개발** - 해외직구 대행 P2P 서비스 웹앱 (정부 지원사업 선정)
- **컴퓨터공학과 4학년** - 한밭대학교
- **GitHub Contributions 2025** - 3,017건
